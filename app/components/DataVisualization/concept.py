...
if "Employee Onboarding" in scenario:
    steps = ["1. Pre-boarding", "2. Welcome Day", "3. Training Week", "4. Team Integration", "5. 30-Day Review", "6. Full Productivity"]
    descriptions = [
        "Paperwork & setup",
        "Orientation & culture",
        "Skills & tools training",
...
fig.show()""", language="python")
    ...
    def render_chart(self, chart_type: str, scenario: str):
        ...
        if chart_type == "Fishbone Diagram":
            self.create_fishbone(scenario)
        elif chart_type == "Pyramid Diagram":
            self.create_pyramid(scenario)
        else:
            self.create_step_by_step(scenario)

    def render_examples(self):
        st.markdown("### 💡 Real-world Examples")

        examples = {
            "Quality Management": "Fishbone diagrams for root cause analysis",
            "Business Strategy": "Porter's Five Forces framework",
            "Problem Solving": "Step-by-step troubleshooting guides",
            "Education": "Learning pathway diagrams",
            "Process Improvement": "Before/after comparison diagrams"
        }
    ...
    def render_key_characteristics(self):
        st.markdown("### 💡 Understanding Concept and Idea Visualization")

        st.markdown("""
        Concept analysis visualizes **abstract ideas and logical relationships**.
        It helps learners and teams understand complex structures and connections.
        """)

        st.markdown("#### 🧠 Clarifies Abstract Concepts")
        st.markdown("""
        Transforms intangible ideas into structured visual representations,
        making them easier to comprehend and navigate.
        """)

        st.markdown("#### 🔗 Shows Logical Relationships")
        st.markdown("""
        Highlights connections such as:
        - Cause-effect  
        - Hierarchies  
        - Dependencies  
        - Similarities  

        Users can see how ideas interact and influence one another.
        """)

        st.markdown("#### 📚 Supports Teaching and Learning")
        st.markdown("""
        Visually organized concepts enhance:
        - Comprehension  
        - Memory retention  
        - Problem-solving  
        - Strategic thinking  
        ...
        st.markdown("#### 🗣️ Facilitates Communication")
        st.markdown("""
        Concept diagrams serve as a **shared language**:
        ...
        st.markdown("#### 🎯 Why Concept Analysis Matters")
        st.markdown("""
        Conceptual visualization turns abstract knowledge into tangible structures,
        enabling reasoning, decision-making, and effective collaboration.
        """)

...
""", language="python")
    ...
    def render_chart(self, chart_type: str, scenario: str):
        ...
        if chart_type == "Mind Map":
            self.create_mind_map(scenario)
        elif chart_type == "SWOT Analysis":
            self.create_swot_analysis(scenario)
        else:
            self.create_journey_map(scenario)
    ...
    def render_key_characteristics(self):
        st.markdown("### 💭 Understanding Qualitative and Conceptual Analysis")

        st.markdown("""
        Qualitative analysis focuses on **ideas, meaning, and conceptual relationships**
        rather than numerical measurement. It supports thinking, planning,
        and shared understanding.
        """)

        st.markdown("#### 🧠 Representing Concepts, Not Numbers")
        st.markdown("""
        Qualitative views work with:
        - Themes and categories  
        - Assumptions and narratives  
        - Ideas and mental models  

        They answer *what*, *why*, and *how* rather than *how much*.
        """)

        st.markdown("#### 🗺️ Facilitating Thinking and Planning")
        st.markdown("""
        Externalizing ideas into structured forms improves clarity.
        Qualitative analysis helps teams plan, prioritize, and reason through uncertainty
        before formal measurement begins.
        """)

        st.markdown("#### 🧩 Organizing Complex Ideas")
        st.markdown("""
        Complex problems involve many interrelated ideas.
        Qualitative structures reduce cognitive load by grouping concepts and
        making abstract relationships visible.
        """)

        st.markdown("#### 🤝 Supporting Collaborative Work")
        st.markdown("""
        Qualitative artifacts create shared mental models.
        They support discussion, alignment, and collaboration across diverse teams
        and areas of expertise.
        """)

        st.divider()

        st.markdown("#### 🎯 Why Qualitative Analysis Matters")
        st.markdown("""
        Qualitative analysis lays the foundation for effective action.
        It ensures problems are well-framed, assumptions are explicit,
        and teams are aligned before moving to quantitative execution.
        """)
